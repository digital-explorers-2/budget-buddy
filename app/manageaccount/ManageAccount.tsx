  ...
  return (
    <div className="w-full text-black">
      <div className="flex min-h-screen p-8">
        <div className="w-full max-w-[1000px] bg-white dark:bg-gray-800 p-6 mx-auto shadow-md rounded-lg">
          <h1 className="text-3xl font-bold mb-8 dark:text-gray-100">
            Manage Account
          </h1>

          <div className="mb-12 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">
              Currency
            </h2>
            <label
              className="block font-medium mb-2 dark:text-gray-100"
              htmlFor="currency"
            >
            ...
            <select
              id="currency"
              className="border rounded-md w-full p-2 mb-4 dark:bg-gray-900 dark:text-gray-100 dark:border-slate-800"
          ...
          <div className="mb-12 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
            ...
            />
            <button
              className="px-4 py-2 bg-green-500 text-white rounded-md mb-4 dark:bg-green-700"
              ...
              {budgets.map(budget => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      className="text-blue-500 flex items-center gap-2 dark:text-blue-300"
                      onClick={() => openEditBudgetModal(budget)}
                    >
                      <FaEdit /> Edit
                    </button>
                    <button
                      className="text-red-500 flex items-center gap-2 dark:text-red-300"
          ...
          {sections.map(section => (
            <div
              key={section.title}
              className="mb-12 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md"
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold mb-0 dark:text-gray-100">
                  {section.title}
                </h2>
              </div>
              <div className="grid grid-cols-3 gap-6">
                {section.categories.map(category => (
                  <div
                    key={category.id}
                    className="bg-gray-200 dark:bg-gray-800 p-4 rounded-md flex justify-center items-center"
                  >
              ...
              <div className="grid grid-cols-3 gap-6 mt-2">
                {section.categories.map(category => (
                  ...
                  >
                    <button
                      className="text-blue-500 flex items-center gap-2 mt-2 dark:text-blue-300"
                      onClick={() =>
                    ...
                    <button
                      className="text-red-500 flex items-center gap-2 dark:text-red-300"
                      onClick={() =>
                        handleDeleteCategory(category.id, section.type)
                      }
                    >
                      <FaTrash /> Delete
                    </button>
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
        ...
        <div className="flex justify-end gap-2">
          <button
            onClick={closeModal}
            className="px-4 py-2 bg-gray-500 text-white rounded-md dark:bg-gray-700"
          >
            Cancel
          </button>
          <button
            onClick={handleCreateCategory}
            className="px-4 py-2 bg-green-500 text-white rounded-md dark:bg-green-700"
          >
            Create
          </button>
        </div>

...
const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t dark:border-t-slate-800 p-8 flex flex-col items-center text-center text-xs">
      <div className="mb-4">
      ...
      <div className="mb-4">
        <a
          href="https://twitter.com/budgetbuddy"
          target="_blank"
          rel="noreferrer"
          className="hover:underline"
        >
        ...
        {" | "}
        <a
          href="https://facebook.com/budgetbuddy"
          target="_blank"
          rel="noreferrer"
          className="hover:underline"
        >
        ...
        {" | "}
        <a
          href="https://instagram.com/budgetbuddy"
          target="_blank"
          rel="noreferrer"
          className="hover:underline"
        >
